...
class MeetPage extends React.Component<IPageProps,IPageState> {
    ...
    loadData=async (args:any)=>{
        ...
        let page = await ManService.searchMeet(args,this.pageIndex,this.pageSize) as PageModel<any>;
    ...
    render() {
        ...
        const columns = [
            ...
            { title: '见面者', dataIndex: 'createUser', key: 'createUser', textAlign:'center',width: 120},
...
export default Form.createForm()(MeetPage);